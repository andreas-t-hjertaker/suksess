...
import { BIG_FIVE_ANALYSE_META, RIASEC_ANALYSE_META } from "@/lib/personality/analyse-meta";
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {bigFiveRanked.map((key) => {
            ...
            const meta = BIG_FIVE_ANALYSE_META[key];
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-3">
          {riasecRanked.slice(0, 3).map((key, rank) => {
            ...
            const meta = RIASEC_ANALYSE_META[key];
            return (
              <div key={key} className="rounded-xl border p-4">

/**
 * Felles STYRK-08 ↔ RIASEC mapping (#172).
 *
 * Én autoritativ kilde for mapping mellom STYRK-08 yrkeskoder og RIASEC-dimensjoner.
 * Brukes av both jobbmatch (nav-stillinger) og karriere-modulen (data-service).
 */
...
// ---------------------------------------------------------------------------
// STYRK-08 → RIASEC (2-sifret, mer spesifikk)
// ---------------------------------------------------------------------------
 ...
 * Prøver 2-sifret kode først (mer spesifikk), deretter 1-sifret.
 */
...
/**
 * Hent STYRK-kode for en karriere-ID.
 */
export function careerToStyrk(careerId: string): string | undefined {
  return CAREER_STYRK_MAP[careerId];
}
